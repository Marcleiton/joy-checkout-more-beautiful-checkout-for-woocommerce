...
if( ! class_exists( 'CMB2_Tabs' ) ) {
    ...
    class CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            wp_register_script( 'cmb-tabs', JOYC_PLUGIN_URL.'cmb2/js/tabs.js', array( 'jquery' ), JOYC_VERSION, true );
            wp_enqueue_script( 'cmb-tabs' );

            wp_enqueue_style( 'cmb-tabs', JOYC_PLUGIN_URL.'cmb2/css/tabs.css', array(), JOYC_VERSION );
